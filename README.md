...
- [ ] What problem does the context API help solve?
  ...
  The context APi allows us to pass data down a tree structure without passing it explicityly to every node between the data container and the destination.
